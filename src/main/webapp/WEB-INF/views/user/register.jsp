          ...
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              <form id="registerForm">
                ...
                <div class="mb-3">
                  <label for="confirmPassword" class="form-label auth-form-label">确认密码</label>
                  <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-lock"></i></span>
                ...
                <div class="mb-3">
                  <label for="email" class="form-label auth-form-label">邮箱</label>
                  <div class="input-group">
              ...
              <div class="text-center mt-3">
                <p class="mb-0">已有账号？<a href="${pageContext.request.contextPath}/view/user/login" class="auth-link">立即登录</a></p>
              </div>
            </div>
          </div>
        </div>
