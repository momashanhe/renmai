...
VALUES ('user', '123456', 'user@example.com');

-- 插入示例联系人数据
INSERT INTO tbl_contact (name, phone, email, address, company, position)
VALUES ('张三', '13800138001', 'zhangsan@example.com', '北京市朝阳区', '张三商贸有限公司', 'CEO'),
