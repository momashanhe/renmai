...
页面路由：
- `GET /view/user/login` - 用户登录页面
- `GET /view/user/register` - 用户注册页面
- `GET /view/contact/list` - 联系人列表页面
- `GET /view/contact/detail` - 联系人详情页面
- `GET /view/contact/add` - 添加联系人页面
- `GET /view/contact/edit` - 编辑联系人页面
...
- `POST /user/logout` - 用户退出接口

### 联系人接口

联系人接口：
- `GET /contact/list` - 获取联系人列表接口
- `GET /contact/detail` - 获取联系人详情接口
- `POST /contact/add` - 添加联系人接口
- `POST /contact/edit` - 编辑联系人接口
- `POST /contact/delete` - 删除联系人接口
- `POST /contact/import` - 导入联系人接口
- `GET /contact/export` - 导出联系人接口
...
执行`src/main/resources/data.sql`脚本创建数据库。
